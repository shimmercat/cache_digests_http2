...
function HashValue(url, etag, validators, N, P){
  console.log(url);
  this.key = this._createKey('https://nejcvukovic/testfolder/test.js');
  this.etag = [url.etag];
...
HashValue.prototype._createKey = function(url) {
...
HashValue.prototype._SHA256 = function(key){
